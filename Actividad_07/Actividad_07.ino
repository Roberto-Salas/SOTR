...
Grupo: 3MM6
En esta actividad, se debe recurrir al uso de los timers. Aqui se crean dos timers, en donde
uno se va a accionar una sola vez y el otro se repetira, estos deben de imprimir su respectivo 
mensaje al puerto serial. Se asigno como actividad 2 codificar que al escribir en el puerto
serial, sea reiniciado el timer.
*/
